...
Napi::Object PackDriveDescriptor(Napi::Env env,
  ...
  object.Set(String::New(env, "enumerator"), String::New(env, instance->enumerator));
  ...
  if (instance->partitionTableType != "") {
    object.Set(String::New(env, "partitionTableType"), String::New(env, instance->partitionTableType));
  } else {
  ...
  object.Set(String::New(env, "size"), Number::New(env, static_cast<double>(instance->size)));

  object.Set(String::New(env, "blockSize"), Number::New(env, static_cast<double>(instance->blockSize)));

  object.Set(String::New(env, "logicalBlockSize"), Number::New(env, static_cast<double>(instance->logicalBlockSize)));
  ...
  for (std::string mountpointPath : instance->mountpoints) {
    ...
    if (index < instance->mountpointLabels.size()) {
      mountpoint.Set(String::New(env, "label"), String::New(env, instance->mountpointLabels[index]));
    }
  ...
  object.Set(String::New(env, "isReadOnly"), Boolean::New(env, instance->isReadOnly));

  object.Set(String::New(env, "isSystem"), Boolean::New(env, instance->isSystem));

  object.Set(String::New(env, "isVirtual"), Boolean::New(env, instance->isVirtual));

  object.Set(String::New(env, "isRemovable"), Boolean::New(env, instance->isRemovable));
